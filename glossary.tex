...
\newglossaryentry{crc32}{
  type=\acronymtype,
  name={CRC32},
  description={\gls{crc} with a resulting 32 \glsuseri{bit} hash value}
}
\newglossaryentry{ksa}{
  type=\acronymtype,
  name={KSA},
...
\newglossaryentry{lorawan}{
  type=\acronymtype,
  name={LoRaWAN},
  description={long range \gls{wan}, operating in the \gls{ism} band and using 128 \glsuseri{bit} \gls{aes} for encryption as well as \gls{mic} for frame integrity}
}
\newglossaryentry{gps}{
  type=\acronymtype,
  name={GPS},
...
\newglossaryentry{x86_64}{
  name={x86-64},
  description={the 64-\glsuseri{bit} version of the \gls{x86} instruction set}
}
