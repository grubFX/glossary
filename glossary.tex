...
\newglossaryentry{btc}{
  name={Bitcoin},
  description={Bitcoin is a worldwide cryptocurrency and digital payment system called the first decentralized digital currency, as the system works without a central repository or single administrator.\footnote{Bitcoin -- \url{https://www.bitcoin.com}}}
}
