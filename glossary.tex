...
\newglossaryentry{etc}{
  type=\acronymtype,
  name={etc.},
  description={et cetera, ``and other things'' / ``and so on''}
}
...
\newglossaryentry{cpm}{
  type=\acronymtype,
  name={CPM},
  first={cost per $1000$ impressions (CPM)},
...
\newglossaryentry{psql}{
  ...
  name={PSQL},
  first={PostrgeSQL},
  description={Postgre\gls{sql}}
}
\newglossaryentry{srd}{
  type=\acronymtype,
  name={SRD},
  first={short range devices (SRD)},
  description={short range devices [band]}
}
\newglossaryentry{ip}{
  type=\acronymtype,
  name={IP},
  first={internet protocol (IP)},
  description={internet protocol [addres]}
}
\newglossaryentry{ftp}{
  type=\acronymtype,
  name={FTP},
...
\newglossaryentry{wget}{
  name={\texttt{wget}},
  description={a command for \gls{unix}-based \glspl{os} for non-interactive download of files from the web supporting \gls{http}, \gls{https} and \gls{ftp}}
}
