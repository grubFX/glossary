...
\newglossaryentry{zwave}{
  name={Z-Wave},
  description={a wireless communications protocol used primarily for home automation. It builds a mesh network using low-energy radio waves to communicate from appliance to appliance, allowing for wireless control of residential appliances and other devices}
}
