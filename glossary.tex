...
\newglossaryentry{nema_17}{
  name={NEMA 17},
  description={a stepper motor with a 1.7 x 1.7 inch faceplate as specified by \gls{nema}}
}
...
\newglossaryentry{apt}{
  name={\texttt{apt[-get]}},
  description={a set of core tools inside \gls{debian} (based \glspl{os}) for un-/installing and updating applications}
}
...
% ...
% UNITS ------------------------------------------------------------------------
\newglossary[un1]{unit}{un2}{un3}{Units}
...
\newglossarystyle{units}{
  ...
  \renewcommand*{\glossaryheader}{
    \textbf{Symbol} & \textbf{Name} & \textbf{Description} \endhead
  }

  \renewcommand*{\glsgroupheading}[1]{}

  \renewcommand*{\glossaryentryfield}[4]{
    \glstarget{##1}{##2} & \glsentryuseri{##1} & ##3 \\
  }
...
\newglossaryentry{volt}{
  type=unit,
  name={V},
  description={unit of electrical voltage},
  user1={Volt},
  sort=v
}
\newglossaryentry{amp}{
  type=unit,
  name={A},
  description={unit of electrical current},
  user1={Ampere},
  sort=a
}
