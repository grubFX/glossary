...
\newglossaryentry{rfid}{
  type=\acronymtype,
  name={RIFD},
  first={RFID (radio frequency identification)},
...
\newglossaryentry{kernel}{
  name={Kernel},
  description={a computer program that manages input/output requests from software, and translates them into data processing instructions for the \gls{cpu} and other electronic components of a computer. It is a fundamental part of a modern computer's \gls{os}}%~\cite{wiki_kernel}}
}
\newglossaryentry{arm}{
  name={ARM},
